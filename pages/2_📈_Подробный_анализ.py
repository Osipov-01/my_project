...
def do_analis(data, columns):
    ...
    for column in columns:
        ...
        with col3:
            ...
            profit_bycolumn = data.groupby(column)['profit_tree'].sum().astype('int') - data.groupby(column)['profit'].sum().astype('int') - int(400000/n)*data.groupby(column)['profit'].сount()
